...
@section('content')
    <div class="px-6 py-20 bg-gray-50 space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-3 mt-[34px] ml-[50px] mr-[50px]">
                <a href="{{ route('pesanan') }}" title="Kembali ke daftar cabang" class="hover:text-gray-800">
                    <svg width="20" height="15" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="w-full bg-white p-6 rounded-xl shadow-md">
                    ...
                    <table class="text-sm font-semibold mb-4 w-full">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="flex justify-between items-center text-sm font-semibold text-gray-700 mt-6">
