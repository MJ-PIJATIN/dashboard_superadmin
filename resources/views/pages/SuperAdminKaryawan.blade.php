        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function loadKaryawanData(url, type) {
                try {
                    ...
                    if (type === 'admin') {
                        renderTable(adminTbody, data, 'karyawan'); // 'karyawan' buat route detail karyawan admin
                    } else {
                        renderTable(financeTbody, data, 'karyawan/finance'); // 'karyawan/finance' buat route detail karyawan finannce
                    }
                } catch (error) {
