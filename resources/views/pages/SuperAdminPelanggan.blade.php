...
@section('content')
    <div class="bg-gray-100 min-h-screen">
        <div class=""
            style="margin-left: 50px; padding-top: 100px; padding-bottom: 100px; padding-right: 24px; margin-right: 26px;">
            {{-- Header --}}
                            ...
                            @foreach ($customers as $index => $customer)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-3 break-words w-[100px]">
                                        ...
                                        @endphp
                                        <form method="POST"
                                            action="{{ route('pelanggan.toggleStatus', ['id' => $customer->id]) }}">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                ...
                <div class="flex justify-between items-center mt-4">
                    ...
                    <div class="flex space-x-1 text-base font-semibold">
                        ...
                        @foreach ($customers->getUrlRange(1, $customers->lastPage()) as $page => $url)
                            <a href="{{ $url }}"
                                class="px-3 py-1 rounded {{ $page == $customers->currentPage() ? 'bg-teal-600 text-white' : 'bg-gray-200 hover:bg-gray-300' }}">
                                {{ $page }}
                            </a>
                        @endforeach
