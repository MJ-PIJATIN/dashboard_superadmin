                        ...
                        <div class="flex-1" style="max-width: 600px;">
                            ...
                            <div class="grid grid-cols-2 gap-x-8 gap-y-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <!-- Jenis Kelamin -->
                                    <div>
                                        <label class="block text-sm text-gray-700 mb-[20px]">Jenis Kelamin*</label>
                                    ...
                                    <!-- Email -->
                                    <div class="mt-10">
                                        <label for="email" class="block text-sm text-gray-700 mb-[5.5px]">Email*</label>
...
@push('scripts')
// Modified JavaScript for TambahTerapis - Consistent with Terapis page
<script>
// Global variables
let successTimeout = null;

// Modal management functions - Consistent with terapis page
const modalManager = {
    show(modalId) {
...
const TerapisForm = {
    ...
    // Form submission functionality - Updated to use modalManager
    formSubmission: {
        init() {
        ...
        handleSubmit(e) {
            ...
            // Show loading spinner using modalManager
            ...
            .then(data => {
                ...
                }, 1000); // Add 1 second delay to match terapis behavior
            })
            .catch(error => {
                setTimeout(() => {
                    modalManager.hide('loading-drawer');
    ...
    init() {
        ...
        // Setup event listeners for modal overlays
        this.setupModalEventListeners();
    },

    // Setup modal event listeners - consistent with terapis page
    setupModalEventListeners() {
        // Modal overlay clicks
        const overlays = ['success-drawer-overlay', 'error-drawer-overlay'];
        ...
        const modalContents = ['success-drawer-content', 'error-drawer-content'];
        ...
        if (errorCloseBtn) {
            errorCloseBtn.addEventListener('click', () => {
                modalManager.hide('error-drawer');
            });
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    TerapisForm.init();
    console.log('TambahTerapis functionality initialized with consistent modal behavior');
});
</script>
@endpush
