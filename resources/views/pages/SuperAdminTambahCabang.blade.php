...
@section('content')
  <div class="px-6 pt-28 pb-10 space-y-6">
    ...
    <div class="flex items-center gap-3">
      <a href="{{ route('cabang') }}" class="hover:text-gray-800">
    ...
    <form action="#" method="POST" class="space-y-5">
      ...
      <div>
      <label for="provinsi" class="block text-base font-semibold text-gray-700 mb-1">Provinsi</label>
      <input type="text" id="provinsi" name="provinsi" maxlength="50"
        class="w-full px-4 py-2 border border-gray-600 rounded-md" placeholder="Maksimal 50 karakter">
      </div>

      <div>
      <label for="kota" class="block text-base font-semibold text-gray-700 mb-1">Kota</label>
      ...
      <input type="text" id="lokasi" name="lokasi" class="w-full px-4 py-2 border border-gray-600 rounded-md"
      ...
      <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-600 rounded-md"
